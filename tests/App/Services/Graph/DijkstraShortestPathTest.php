...
class DijkstraShortestPathTest extends TestCase
{
     ...
     */
    protected static $dijkstraShortestPath;
    ...
    protected function setUp()
    {
        ...
        self::$dijkstraShortestPath = new DijkstraShortestPath();
    }


    public function testShortestPath()
    {
        $result1 = self::$dijkstraShortestPath->shortestPath(self::$graph, 's', 'e');
        $result2 = self::$dijkstraShortestPath->shortestPath(self::$graph, 's', 'd');
        $result3 = self::$dijkstraShortestPath->shortestPath(self::$graph, 'a', 'e');
